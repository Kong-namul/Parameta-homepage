...
const needs = [
  { kr: "안정성", en: "Reliability", desc: "자사 앱에 붙였을 때 죽지 않고 24시간 돌아간다" },
  { kr: "관측 가능성", en: "Observability", desc: "블록체인을 몰라도 한눈에 — 누구 지갑에 얼마, API 성공/실패" },
  { kr: "통제권", en: "Control", desc: "법적·행정적 개입 가능한 관리자 권한" },
];
    ...
    <section className="py-24 border-b border-[var(--border-subtle)]">
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-6 mt-12">
          {needs.map((n) => (
            <div key={n.kr} className="space-y-3 p-6 border border-[var(--border)] rounded-md">
