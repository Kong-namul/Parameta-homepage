...
const COPY = {
  ...
  en: {
    ...
    intro: "These terms govern the use of the website operated by PARAMETA Inc.",
    h1: "1. Services Provided",
    p1:
      "Through this site we provide product and service information, accept inquiries, and offer related materials.",
    h2: "2. User Obligations",
    p2: "Users must comply with applicable laws and these terms when using the site.",
    h3: "3. Limitation of Liability",
    p3:
      "We do not guarantee the accuracy or completeness of information posted on this site and disclaim liability for damages arising from its use, to the extent permitted by law.",
    note: "This page is a v1 placeholder. It will be updated to the final terms after legal review.",
  },
};
