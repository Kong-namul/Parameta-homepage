    ...
    <>
      <section className="py-24 border-b border-[var(--border-subtle)]">
        <Container>
          ...
          <p className="text-[var(--text-secondary)] mt-6 max-w-2xl text-lg">
            2016년 설립. ICONLOOP에서 PARAMETA로. 한국 1세대 블록체인 인프라 기업.
          </p>
        </Container>
      </section>
      <section className="py-24 border-b border-[var(--border-subtle)]">
        <Container>
          ...
          <h2 className="h-section max-w-2xl">공공·금융이 먼저 부르는 한국 1세대 Web3 인프라.</h2>
          <p className="text-[var(--text-secondary)] mt-6 max-w-2xl">
            은행·기관·발행자가 Web3로 들어올 때 그 길을 만들고 함께 걷는 능동적 인도자.
          </p>
        </Container>
      </section>
      <section className="py-24">
        <Container>
          ...
          <h2 className="h-section">회사 연혁.</h2>
          <p className="text-[var(--text-secondary)] mt-4">
            <a href="/trust" className="text-[var(--accent-primary)]">Trust 페이지의 Track Record →</a>에서 9년 마일스톤 전체 보기.
          </p>
        </Container>
      </section>
    </>
