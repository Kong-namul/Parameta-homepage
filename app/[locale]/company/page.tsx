...
const COPY = {
  ...
  en: {
    heroSub:
      "Founded in 2016. From ICONLOOP to PARAMETA — Korea's first-generation blockchain infrastructure company.",
    visionTitle: "First-generation Web3 infrastructure called on first by Korea's public sector and finance.",
    visionDesc:
      "An active guide that builds the path and walks it with banks, institutions, and issuers as they move into Web3.",
    historyTitle: "Company history.",
    historyLink: "Track Record on the Trust page →",
    historyDesc: " — see all nine years of milestones.",
  },
};
