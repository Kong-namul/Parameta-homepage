...
const COPY = {
  ...
  en: {
    heroTitle: "Unified digital asset trading.",
    heroSub:
      "Multiple exchanges, settlement, and real-time monitoring as one. Secure vault custody included.",
    explore: "Explore →",
    contactSales: "Contact sales",
    capabilitiesTitle: "Core value.",
    capabilities: [
      { name: "Multi-exchange connectivity", desc: "Unified CEX and DEX interface" },
      { name: "Unified trading", desc: "Operate assets through a single API" },
      { name: "Settlement and real-time monitoring", desc: "Positions and PnL at a glance" },
      { name: "Secure custody", desc: "Vault-based asset custody" },
    ],
    personasTitle: "User personas.",
    personas: [
      { role: "Trader", desc: "Operate across multiple exchanges" },
      { role: "STO issuer", desc: "Digital asset trading and settlement" },
      { role: "Asset manager", desc: "Portfolio and client asset operations" },
    ],
    flowTitle: "Asset flow diagram.",
    flowPlaceholder:
      "Interactive diagram placeholder — deposit/withdraw → trade → settle flow (Phase 11 content).",
    vaultTitle: "Built-in vault and custody.",
    vaultDesc:
      "An add-on to Supercycl. Secure custody and segregated storage, built with PARAMETA's own technology.",
    vaultItems: [
      { name: "Segregated storage", desc: "Cold-wallet and multi-sig policies" },
      { name: "Withdrawal approval workflow", desc: "Amount, frequency, and address policies" },
      { name: "Audit logs", desc: "Every asset movement tracked" },
    ],
    useCasesTitle: "Use cases.",
    useCases: [
      {
        tag: "Hana Wallet partnership",
        name: "Stablecoin payment debit-card infrastructure",
        desc: "Joint research on next-generation KYC-based models",
      },
      {
        tag: "Unified issuer operations",
        name: "Automatic multi-exchange routing",
        desc: "Liquidity and cost optimization",
      },
    ],
    integrationTitle: "API & SDK.",
    docsCta: "Docs →",
...
export default async function SupercyclPage({ params }: { params: Promise<{ locale: string }> }) {
