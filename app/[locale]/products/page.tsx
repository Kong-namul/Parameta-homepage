...
const COPY = {
  ...
  en: {
    label: "OUR PRODUCTS",
    title: "Four products, equal hierarchy.",
    desc: "ParaSta is the solution platform; Supercycl, MyID 2.0, and broof are individual products. All four are presented at the same visual level.",
    items: [
      {
        slug: "parasta",
        name: "ParaSta",
        type: "Solution",
        desc: "Digital asset finance infrastructure. Issuance · Wallet · Orchestration · Onchain KYC + Unified Admin.",
        featured: true,
      },
      {
        slug: "supercycl",
        name: "Supercycl",
        type: "Product",
        desc: "Digital asset integrated trading. Multi-exchange · settlement · realtime monitoring. (+ Vault add-on)",
        featured: true,
      },
      {
        slug: "myid",
        name: "MyID 2.0",
        type: "Product",
        desc: "Public-sector DID subscription. First blockchain CSAP certification in Korea. 1-week deployment.",
      },
      {
        slug: "broof",
        name: "broof",
        type: "Product",
        desc: "Blockchain certificate issuance. Tamper-proof, permanent. broof.io",
      },
    ],
    cta: "→ See details",
  },
...
export default async function ProductsIndex({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const t = locale === "en" ? COPY.en : COPY.ko;
  return (
    <>
