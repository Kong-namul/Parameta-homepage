...
const COPY = {
  ...
  en: {
    heroTitle: "Digital asset financial infrastructure for enterprise.",
    heroSubtitle:
      "We resolve the complex regulatory and technical barriers enterprises face when issuing and operating digital assets — in one place.",
    exploreModules: "Explore modules ↓",
    contactSales: "Contact sales",
    needsTitle: "The three things customers want most.",
    needs: [
      { en: "Reliability", title: "Reliability", desc: "Plugs into your app and runs 24/7 without breaking." },
      { en: "Observability", title: "Observability", desc: "See everything at a glance — no blockchain knowledge required." },
      { en: "Control", title: "Control", desc: "Admin authority for legal and regulatory intervention." },
    ],
    architectureTitle: "Four core modules + Unified Admin.",
    modules: [
      { id: "issuance", name: "Issuance", desc: "Stablecoin mint, burn, and reserves" },
      { id: "wallet", name: "Wallet", desc: "Digital asset wallet infrastructure" },
      { id: "orchestration", name: "Orchestration", desc: "Fiat ↔ Crypto middleware" },
      { id: "onchain-kyc", name: "Onchain KYC", desc: "Verify Once, Use Everywhere" },
    ],
    unifiedAdminDesc: "Operations console connecting all four modules",
    keyFeaturesTitle: "Three Key Features.",
    features: [
      { name: "Modular APIs", desc: "Subscribe only what you need — build without owning infrastructure." },
      { name: "Regulatory readiness", desc: "Built-in AML and KYC; a minimum line of defense when things go wrong." },
      { name: "Flow and revenue design", desc: "Additional business models via Web3 transition." },
    ],
    personasTitle: "Four user roles.",
    personas: [
      { role: "Consumer", desc: "Transfer, payment, and FX for end users", app: "ParaSta W" },
      { role: "Partner", desc: "Digital asset settlement for merchants and partners", app: "ParaSta W" },
      { role: "Service Admin", desc: "KYC/KYB, transaction monitoring, fee policy", app: "ParaSta W" },
      { role: "Token Admin", desc: "Mint/burn, reserves, reward distribution", app: "ParaSta T" },
    ],
    modelsTitle: "Three proven applied models.",
    models: [
      { tag: "Payments", name: "Inscobee-style local currency", desc: "Consumer + Partner + Service Admin + Token Admin" },
      { tag: "Portfolio", name: "Mirae Asset-style", desc: "Consumer + Service Admin" },
      { tag: "STO", name: "Real estate trust", desc: "End-to-end security tokens" },
    ],
    pricingTitle: "Adopt module by module.",
    pricingDesc:
      "Transaction fees (Onchain KYC + Transfers API) + admin operations subscription. Mix and match the features you need.",
    customersPlaceholder: "Customer logo grid (adding NDA-cleared logos first — content phase)",
    talkToSalesQuote: "Talk to sales (per-module quote)",
    closingTitle: "Ready to start?",
    talkToEngineering: "Talk to engineering",
  },
};

export default async function ParaStaPage({ params }: { params: Promise<{ locale: string }> }) {
