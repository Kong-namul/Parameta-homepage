...
type Params = Promise<{ locale: string; segment: string }>;
    ...
    <>
      ...
      <section className="py-24 border-b border-[var(--border-subtle)]">
        <Container>
          ...
          <h2 className="h-section">사용 제품·모듈.</h2>
          <ul className="grid md:grid-cols-2 gap-4 mt-12">
      ...
      <section className="py-24">
        <Container className="text-center max-w-2xl mx-auto">
          <h2 className="h-section">Ready to start with {s.name}?</h2>
          <Button variant="primary" className="mt-8">Talk to sales</Button>
        </Container>
      </section>
    </>
