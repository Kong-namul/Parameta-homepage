...
import { getSolutions, solutions, type SolutionKey } from "@/lib/solutions";
...
const COPY = {
  ...
  en: {
    label: "SOLUTION FOR",
    talkToSales: "Talk to sales",
    appliedTitle: "Applied models.",
    productsTitle: "Products and modules used.",
    closingPrefix: "Ready to start with",
  },
};
...
export default async function SolutionPage({ params }: { params: Params }) {
  ...
  const sols = getSolutions(locale);
  const s = sols[segment as SolutionKey];
