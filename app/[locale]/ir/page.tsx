...
const COPY = {
  ...
  en: {
    heroTitle: "IR — preparing for KOSDAQ listing.",
    heroSub:
      "Nine years of operating history from Korea's first-generation blockchain company, plus details on the current ₩20B round.",
    overviewTitle: "Company and financial summary.",
    statSinceLabel: "SINCE FOUNDING",
    statCumulativeLabel: "CUMULATIVE INVESTMENT",
    statCurrentLabel: "CURRENT ROUND (IN PROGRESS)",
    fundingTitle: "Funding history.",
    fundingPlaceholder:
      "Round-by-round details placeholder — to be populated from public disclosures during the content phase.",
    materialsTitle: "Materials and IR decks.",
    materialsDesc: "PDFs and annual reports will be added during the content phase.",
    contactTitle: "Investor contact.",
    contactPrefix: "Investor and IR inquiries:",
    irRequest: "Request an IR meeting",
    futureNote:
      "Post-listing: quarterly reports, business reports, and stock information will be added here.",
  },
};
