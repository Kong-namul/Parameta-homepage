...
const COPY = {
  ...
  en: {
    ...
    intro:
      "PARAMETA Inc. (the “Company”) takes user privacy seriously and complies with the Personal Information Protection Act.",
    h1: "1. Information We Collect",
    p1:
      "For inquiries: name, company, title, email, phone, and message — used solely for sales response.",
    h2: "2. Retention Period",
    p2: "Retained for three years after the consultation ends, then securely destroyed.",
    h3: "3. Privacy Officer",
    p3Prefix: "Email:",
