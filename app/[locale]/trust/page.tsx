...
const COPY = {
  ...
  en: {
    heroTitle: "Nine years and the certifications we earned.",
    heroSub:
      "Instead of head-to-head comparisons, we let our certifications and nine years of operations speak for themselves.",
    certTitle: "Certifications.",
    badges: ["CSAP industry-first", "K-BTF pilot", "GS certified", "SW Quality Award", "Digital Marketplace"],
    trackTitle: "9 years.",
    casesTitle: "Case studies.",
    statsTitle: "By the numbers.",
    closingTitle: "Why these matter to your decision.",
    closingDesc: "Trust is proven over time.",
    closingCta: "Talk to our team",
    statInvestment: "CUMULATIVE INVESTMENT",
    statOperating: "OPERATING",
    statTps: "LOOPCHAIN VERIFIED",
